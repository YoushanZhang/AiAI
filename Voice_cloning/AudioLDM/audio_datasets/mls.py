...
class MLS(TorchDataset):
    ...
    """
    def __init__(self, data_dir='D:\\audioldm\\tts\\simple-tts\\data\\mls\\mls_english' , split='train', debug=False, tokenizer=None, sampling_rate=None, max_text_len=256):
        super().__init__()
...
if __name__ == "__main__":
    ...
    sf.write(f'D:\\audioldm\\tts\\simple-tts\\data\\mls\\mls_english\\train\\audio\\part2\\segmentspart2\\part2_segmentspart2_44.wav', example['wav'].squeeze().numpy(), ENCODEC_SAMPLING_RATE)
    with open(f'D:\\audioldm\\tts\\simple-tts\\data\\sample.txt', 'w') as f:
