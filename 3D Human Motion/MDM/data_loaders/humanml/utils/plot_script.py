...
def plot_3d_motion(save_path, kinematic_tree, joints, title, dataset, figsize=(3, 3), fps=120, radius=3,gt_frames=[]): #vis_mode='default', gt_frames=[]): # newly added
    ...
    def update(index):
        ...
        for i, (chain, color) in enumerate(zip(kinematic_tree, colors)): #used_colors)): # newly added
            if i < 5:
                linewidth = 4.0
            else:
                linewidth = 2.0
