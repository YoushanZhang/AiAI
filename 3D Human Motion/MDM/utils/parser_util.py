...
def parse_and_load_from_model(parser):
    ...
    print(f"Expected args.json path: {args_path}")  # newly added
...
def train_args():
    ...
    # Check if '--overwrite' is already an option in the parser
    overwrite_exists = any('--overwrite' in action.option_strings for action in parser._actions)

    if not overwrite_exists:
        parser.add_argument('--overwrite', action='store_true', help='Overwrite the save_dir if it exists.')
