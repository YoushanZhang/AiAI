...
from utils.metrics import calculate_frechet_distance # added
    ...
    for motion_loader_name, motion_loader in motion_loaders.items():
        ...
        with torch.no_grad():
            for idx, batch in enumerate(motion_loader):
                ...
                # print("Number of text embeddings:",len(text_embeddings)) # added
                # print("Number of motion embeddings:",len(motion_embeddings)) # added
            ...
            # print("Number of all_motion embeddings:",len(all_motion_embeddings)) # added
        ...
        # print(f'---> Motion_Embeddings: {all_motion_embeddings}') # added
...
def evaluation(log_file):
    with open(log_file, 'w') as f:
        ...
        for replication in range(replication_times):
            ...
            print("Motion Loaders:", motion_loaders)            
...
if __name__ == '__main__':
    ...
    print("Bhai tu idar se chal raha h na?")
    
    gt_loader, gt_dataset = get_dataset_motion_loader(dataset_opt_path, batch_size, device)
    wrapper_opt = get_opt(dataset_opt_path, device)
    eval_wrapper = EvaluatorModelWrapper(wrapper_opt)

    log_file = '/content/drive/MyDrive/text-to-motion/t2m_evaluation.log'
    evaluation(log_file)
    # animation_4_user_study('./user_study_t2m/')b